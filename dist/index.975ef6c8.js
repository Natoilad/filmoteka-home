...
var _getGenres = require("./js/get-genres");
var _getFilmsJs = require("./js/get-films.js");
...
},{}],"6qzlu":[function(require,module,exports) {
// console.log('get-films');
var _createMovieCardJs = require("./createMovieCard.js");
var _fetchTrendsJs = require("./fetchTrends.js");
var _localJs = require("./local.js");
var _local = require("./local");
var _searchRequest = require("./searchRequest");
var _modalWindowJs = require("./modal-window.js");
//Додаю сюди для перевірки функціоналу, поки без підключення
//Модальне вікно
(0, _local.card).addEventListener("click", (0, _modalWindowJs.showMovieMain));

},{"./createMovieCard.js":"8zLyu","./fetchTrends.js":"kKsDb","./local.js":"fHpqR","./local":"fHpqR","./searchRequest":"druT5","./modal-window.js":"bg8pZ"}],"8zLyu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./get-genres":"bbJ9W","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kKsDb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// let page = 1;
parcelHelpers.export(exports, "fetchTrends", ()=>fetchTrends);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const BASE_URL = "https://api.themoviedb.org/3/";
const KEY_API = "0b11624b950ea9c4284f61844023b09c";
async function fetchTrends(page, request) {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}trending/movie/week?api_key=${KEY_API}&page=${page}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fHpqR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"druT5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "globalRequest", ()=>globalRequest);
parcelHelpers.export(exports, "currPageGlobe", ()=>currPageGlobe);
...
let globalRequest;
let currPageGlobe;
let page = 1; // async function inputRequest(e) {
 //   e.preventDefault();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bg8pZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9j1Dd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "paginationBoxElem", ()=>paginationBoxElem);
var _renderJs = require("./render.js");
var _fetchMovie = require("./fetchMovie");
var _fetchTrendsJs = require("./fetchTrends.js");
var _paginFunctionJs = require("./paginFunction.js");
...
async function inputRequest(e) {
    ...
    try {
        const data = await (0, _fetchMovie.fetchMovies)(page, request, lang);
        if (data.results.length === 0) {
            notif.style.visibility = "visible";
            setTimeout(()=>{
                notif.style.visibility = "hidden";
        ...
        globalRequest = request;
        (0, _paginFunctionJs.pagination)(data.page, data.total_pages);
    } catch (err) {
        console.log("Error");
    }
}
async function getMovies(page1 = 1) {
    let resp;
    if (globalRequest) {
        (0, _loader.loaderOn)();
        resp = await (0, _fetchMovie.fetchMovies)(page1, globalRequest, lang);
        currPageGlobe = resp.page;
        window.onload = (0, _loader.loaderOff)();
        return resp;
    } else {
        (0, _loader.loaderOn)();
        resp = await (0, _fetchTrendsJs.fetchTrends)(page1);
        window.onload = (0, _loader.loaderOff)();
        currPageGlobe = resp.page;
        return resp;
    }
...
function paginationHandler(evt) {
    ...
    if (evt.target.textContent === "\uD83E\uDC78") getMovies(currPageGlobe -= 1).then((data)=>{
        (0, _renderJs.render)(data);
        (0, _paginFunctionJs.pagination)(data.page, data.total_pages);
    });
    else if (evt.target.textContent === "\uD83E\uDC7A") getMovies(currPageGlobe += 1).then((data)=>{
        (0, _renderJs.render)(data);
        (0, _paginFunctionJs.pagination)(data.page, data.total_pages);
    });
    else {
...
},{"./render.js":"6Nkx6","./fetchMovie":"e6uCj","./fetchTrends.js":"kKsDb","./paginFunction.js":"iwT9K","./loader":"aAovl","./local.js":"fHpqR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Nkx6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function render(data) {
    localStorage.setItem((0, _local.CURRENT_MOVIES), JSON.stringify(data));
    (0, _local.card).innerHTML = (0, _createMovieCard.createMovieCard)(JSON.parse(localStorage.getItem((0, _local.CURRENT_MOVIES))).results);
}

},{"./local":"fHpqR","./createMovieCard":"8zLyu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e6uCj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY_API = "0b11624b950ea9c4284f61844023b09c";
async function fetchMovies(page, request, lang) {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}?api_key=${KEY_API}&query=${request}&page=${page}&language=${lang}`);
        return response.data;
    } catch (err) {
        throw new Error(response.statusText);
    }
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iwT9K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currPageGlobe", ()=>currPageGlobe);
...
function pagination(currPage, allPages) {
    ...
    if ((0, _themeChange.controlElem).classList.contains("checked")) {
        const liElem = [
            ...paginationBoxElem.children
        ].forEach((li)=>{
            li.classList.toggle("dark");
        });
        const liElemCard = [
            ...cardBoxElem.children
        ].forEach((li)=>{
            li.classList.toggle("dark-card");
        });
    } else {
        const liElemCardlight = [
            ...cardBoxElem.children
        ].forEach((li)=>{
...
},{"./theme-change":"E7umM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"E7umM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "controlElem", ()=>controlElem);
var _localJs = require("./local.js");
var _loader = require("./loader");
var _langSwitch = require("./lang-switch");
const controlElem = document.querySelector(".theme__control");
...
function onThemeChange(evt) {
    (0, _loader.loaderOn)();
    location.reload();
    if (evt.target.classList.contains("theme__control")) controlElem.classList.toggle("checked");
...
function onLangChange(evt) {
    if (evt.target.classList.contains("lang__control")) langControlElem.classList.toggle("checked");
    if (langControlElem.classList.contains("checked")) {
        (0, _localJs.logo).textContent = "\u0424\u0456\u043B\u044C\u043C\u043E\u0442\u0435\u043A\u0430";
        (0, _localJs.library).textContent = "\u041C\u041E\u042F \u0411\u0406\u0411\u041B\u0406\u041E\u0422\u0415\u041A\u0410";
        (0, _localJs.home).textContent = "\u0413\u041E\u041B\u041E\u0412\u041D\u0410";
        searchLangGlobal = "en";
        localStorage.setItem((0, _localJs.LANG), ukranian);
    } else {
        (0, _localJs.logo).textContent = "Filmoteka";
        (0, _localJs.library).textContent = "MY LIBRARY";
        (0, _localJs.home).textContent = "HOME";
        searchLangGlobal = "uk";
        localStorage.setItem((0, _localJs.LANG), english);
    }
}
function storageLang(currentLang1 = "english") {
    if (currentLang1 === null) return;
    if (currentLang1 === english) {
        searchLangGlobal = "en";
...
},{"./local.js":"fHpqR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iwZ7p":[function(require,module,exports) {
