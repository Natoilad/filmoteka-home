...
})({"6NN7T":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f6ad33fbd4c4bb6b";
...
},{}],"3r8X8":[function(require,module,exports) {
var _fetchTrends = require("./fetchTrends");
const refs = {
...
function onClickNext() {
    offset += sliderWidth;
    if (offset > sliderWidth * 3) offset = 0;
    refs.sliderList.style.left = -offset + "px";
}
function onClickPrev() {
    offset -= sliderWidth;
    if (offset < 0) offset = sliderWidth * 3;
    refs.sliderList.style.left = -offset + "px";
}
function createSliderItems(data) {
    let markup = data.map(({ poster_path , name , title , genre_ids , overview , release_date , id , vote_average ,  })=>{
        return `
...
(0, _fetchTrends.fetchTrends)(page).then((res)=>{
    console.log(res);
    refs.sliderList.insertAdjacentHTML("beforeend", createSliderItems(res.results));
});

},{"./fetchTrends":"kKsDb"}],"kKsDb":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6NN7T","3r8X8"], "3r8X8", "parcelRequired7c6")

//# sourceMappingURL=library.d4c4bb6b.js.map
